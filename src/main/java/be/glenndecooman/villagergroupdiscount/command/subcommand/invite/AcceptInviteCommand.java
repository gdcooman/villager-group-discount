...
public class AcceptInviteCommand implements SubCommand {
                                ...
                                if (player.getGroup() == null) {
                                    ...
                                    if (group != null) {
                                        ...
                                        try {
                                            ...
                                            MsgUtil.success(sender, String.format("Welcome to %s!", group.getName()));
                                            MsgUtil.info(inviter, String.format("%s has accepted your invite!", player.getName()));
    ...
    public void showUsage(Player player) {
        showUsage(player, "/vgd invite accept <inviteID>");
    }
}
